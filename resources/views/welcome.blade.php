                ...
                <div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
                    ...
                    <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" action="#">
                        ...
                        <div class="text-center mb-10">
                            ...
                            <p class="text-info mb-3">Version 1.0</p>
                            ...
                            <div class="text-gray-400 fw-bold fs-4 d-none">New Here?
                                <a href="../../demo8/dist/authentication/flows/dark/sign-up.html"
                        ...
                        <div class="text-center">
                            ...
                            <!--end::Separator-->
                            <!--begin::Google link-->
                            <a href="#" class="btn btn-flex flex-center btn-light btn-lg w-100 mb-5 d-none">
