        ...
        <div class="card-body">
            <div class="alert alert-success d-flex align-items-center p-5 mb-10">
                ...
                <div class="d-flex flex-column">
                    <h4 class="mb-1 text-success">Welcome </h4>
                    <span>
                        Service Enterprice Resource Planning Indonesia From PT.Bumi Tekno Indonesia
                    </span>
                    <span>Version : 1.0 </span>
                </div>
            </div>
            <p class="text-info">
                Choose and use this service according to your needs.
                <br>
                Send your Criticism and suggestions for the development and experience of this service to
                Email :
                <a href="mailto:bumiteknoindonesia@gmail.com">bumiteknoindonesia@gmail.com</a>
            </p>
        </div>
    </div>
    <div class="card">
