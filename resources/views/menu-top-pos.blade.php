<div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch"
    ...
    <div class="menu-item me-lg-1">
        <a class="menu-link {{ request()->is('home') ? 'active' : '' }}  py-3" href="{{ route('dashboard') }}">
    ...
    @canany(['create-customer', 'edit-customer', 'delete-customer', 'create-customer', 'edit-customer',
        ...
        <div data-kt-menu-trigger="click"
            class="menu-item menu-lg-down-accordion me-lg-1  {{ request()->is('customer*') || request()->is('supplier*') || request()->is('departement*') ? 'show' : '' }} "
    ...
    @canany(['create-category-product', 'edit-category-product', 'delete-category-product', 'create-product',
        ...
        <div data-kt-menu-trigger="click"
            class="menu-item menu-item menu-lg-down-accordion me-lg-1  {{ request()->is('productpos*') ||
    ...
    @canany(['report-daily-pos'])
        <div data-kt-menu-trigger="click"
            class="menu-item menu-lg-down-accordion me-lg-1 {{ request()->is('report*') ? 'show' : '' }} "
            data-kt-menu-placement="bottom-start">
