<div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch"
    ...
    <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start"
        class="menu-item menu-lg-down-accordion me-lg-1 show menu-dropdown">
        ...
        <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px "
            ...
            style="z-index: 105; position: fixed; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(0px, 591px, 0px);">
            <div class="menu-item">
            ...
            <div class="menu-item">
                <a class="menu-link py-3" href="{{ route('account.company') }}" title="" data-bs-toggle="tooltip"
                    data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right"
                    data-bs-original-title="Company">
                    <span class="menu-icon">
            ...
            <div class="menu-item">
                <a class="menu-link py-3" href="{{ route('account.index') }}" title="" data-bs-toggle="tooltip"
                    data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right"
