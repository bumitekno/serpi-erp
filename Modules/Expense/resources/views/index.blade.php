...
@endpush
@push('modals')
    <div class="modal fade" tabindex="-1" id="kt_modal_expense">
        <form id="kt_docs_formvalidation_text" class="form" action="{{ route('expense.store') }}" autocomplete="off"
            method="POST">
            @csrf
...
@section('content')
    <div class="d-flex flex-wrap flex-stack pb-7">
        <div class="d-flex flex-wrap align-items-center my-1">
            <h3 class="fw-bolder me-5 my-1"> Expense </h3>
            <!--begin::Search-->
            <form name="filterse" action="{{ route('expense.search') }}" method="POST">
                @csrf
            ...
            @can('create-income')
                <a href="javascript:;" class="btn btn-bg-light btn-icon-info btn-text-info mb-2" data-bs-toggle="modal"
                    data-bs-target="#kt_modal_expense">
        ...
        <div class="d-flex flex-wrap my-1">
            <span class="text-muted me-2 ">Total Expense</span>
            ...
            <div class="col-md-6 col-xxl-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                        <!--begin::Name-->
                        <a href="javascript:;"
                            class="fs-4 text-gray-800 text-hover-primary fw-bolder mb-3">{{ Str::title($expenses?->name) }}</a>
                        <!--end::Name-->

                        <div class="fw-bold text-gray-400 mb-6">
                            @php
                                $amount = \Modules\Expense\app\Models\TransactionExpense::where('id_expense', $expenses->id)->sum('amount');
                            @endphp
                        ...
                        <form action="{{ route('expense.destroy', $expenses->id) }}" method="post">
                            ...
                            <div class="d-flex flex-center flex-wrap ">
                                ...
                                <div class="border border-gray-300 border-dashed rounded min-w-80px py-3 px-4 mx-2 mb-3">
                                    @can('show-expense')
                                        <a href="{{ route('expense.show', $expenses->id) }}"
                                ...
                                <!--begin::Stats-->
                                <div
                                    class="border border-gray-300 border-dashed rounded min-w-80px py-3 px-4 mx-2 mb-3 @if ($expenses->id == 1) d-none @endif ">
                                    @can('delete-expense')
                                ...
                                <!--begin::Stats-->
                                <div class="border border-gray-300 border-dashed rounded min-w-80px py-3 px-4 mx-2 mb-3">
                                    @can('create-transaction-expense')
                                        <a href="{{ route('expense.create_trans', $expenses->id) }}"
        ...
        @empty
            <div class="alert alert-danger d-flex align-items-center p-5 mb-10">
                ...
                <div class="d-flex flex-column">
                    ...
                    <span>Expense no record found !.</span>
                </div>
            </div>
        @endforelse
    </div>
