    ...
    <div class="card">
        <div class="card-header mt-3">
            <div class="float-start">
                Transaction Expense {{ Str::title($expense->name) }}
            </div>
            <div class="float-end">
        ...
        <div class="card-body">
            <div class="row g-5 g-xl-8">
                <div class="col-lx-4">
                    <form action="{{ route('expense.storetrans') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" value="{{ $expense->id }}" name="id_expense">
                        <div class="mb-3 row">
    ...
    <script>
        ...
        $(function() {
            ...
            var table = $('.data-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('expense.create_trans', $expense->id) }}",
                order: [],
                columnDefs: [{
                    "targets": [0]
                }],
