        ...
        init: function () {
            (() => {
                var o = FormValidation.formValidation(e, {
                    fields: { user_name: { validators: { notEmpty: { message: "Full name is required" } } }
                    ...
                    confirmpassword: { validators: { notEmpty: { message: " Confirm Password is required" } } },
                    user_role: { validators: { notEmpty: { message: " Choose Roles is required" } } }
                 },
                                                  ...
                                                  $.ajax({
                                                    ...
                                                    success:function(r){
                                                        Swal.fire({ text: r.message, icon: "success", buttonsStyling: !1, confirmButtonText: "Ok, got it!", customClass: { confirmButton: "btn btn-primary" } }).then(function (e) {
                                                            e.isConfirmed && (location.href = r.redirect);
                                                        })
                                                    },error:function(e){
