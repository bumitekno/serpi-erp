            ...
            <div class="col-xl-3">
                ...
                <a href="javascript:;" class="card bg-primary hoverable card-xl-stretch mb-xl-8">
                    ...
                    <div class="card-body">
                        ...
                        <!--end::Svg Icon-->
                        <div class="text-white fw-bolder fs-2 mb-2 mt-5">Purchase Success</div>
            ...
            <div class="col-xl-3">
                ...
                <a href="javascript:;" class="card bg-danger hoverable card-xl-stretch mb-5 mb-xl-8">
                    ...
                    <div class="card-body">
                        ...
                        <!--end::Svg Icon-->
                        <div class="text-gray-100 fw-bolder fs-2 mb-2 mt-5">Purchase Cancel </div>
            ...
            <div class="col-xl-3">
                ...
                <a href="javascript:;" class="card bg-warning hoverable card-xl-stretch mb-5 mb-xl-8">
                    ...
                    <div class="card-body">
                        ...
                        <!--end::Svg Icon-->
                        <div class="text-gray-100 fw-bolder fs-2 mb-2 mt-5">Purchase Pending </div>
                        ...
                        <div class="row">
                            ...
                            <div class="d-flex align-items-center mb-7">
                                ...
                                <div class="d-flex flex-column">
                                    <a href="javascript:;" class="text-dark text-hover-primary fs-6 fw-bolder">Purchase
                                        Success</a>
                                    <span class="text-muted fw-bold">Expense Transaction Purchase Success</span>
                            ...
                            <div class="d-flex align-items-center mb-7">
                                ...
                                <div class="d-flex flex-column">
                                    <a href="javascript:;" class="text-dark text-hover-primary fs-6 fw-bolder">Purchase
                                        Cancel</a>
                                    <span class="text-muted fw-bold">Expense Transaction Purchase Cancel</span>
                            ...
                            <div class="d-flex align-items-center mb-7">
                                ...
                                <div class="d-flex flex-column">
                                    <a href="javascript:;" class="text-dark text-hover-primary fs-6 fw-bolder">Purchase
                                        Pending </a>
                                    <span class="text-muted fw-bold">Expense Transaction Purchase Pending</span>
                    ...
                    <tbody class="text-gray-600 fw-bold">
                        @forelse ($transaction as $transactions)
                            <tr>
                                ...
                                <td class="text-end ">
                                    <form action="{{ route('purchase.destroy', $transactions->id) }}" method="post">
                                        @csrf
                                        @method('DELETE')
                                        <div class="py-5">
                                            <a href="{{ route('purchase.show', $transactions->id) }}"
                                            ...
                                            @can('edit-purchase')
                                                @if ($transactions->note != 'cancel')
                                                    <a href="{{ route('purchase.edit', $transactions->id) }}"
