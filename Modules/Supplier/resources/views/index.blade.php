...
@push('modals')
    <div class="modal fade" tabindex="-1" id="kt_modal_supplier">
        <form id="kt_docs_formvalidation_text" class="form" action="{{ route('supplier.store') }}" autocomplete="off"
...
@section('content')
    <div class="d-flex flex-wrap flex-stack pb-7">
        <div class="d-flex flex-wrap align-items-center my-1">
            <h3 class="fw-bolder me-5 my-1"> Supplier </h3>
            <!--begin::Search-->
            <form name="filterse" action="{{ route('supplier.search') }}" method="POST">
                @csrf
                    ...
                    <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                        ...
                        <div class="symbol symbol-65px symbol-circle mb-5">
                            @if (!empty($supplier->image))
                                <img src="{{ Storage::url($supplier->image) }}" alt="image">
                            @else
                        ...
                        <form action="{{ route('supplier.destroy', $supplier->id) }}" method="post">
                            ...
                            <div class="d-flex flex-center flex-wrap">
                                ...
                                <!--begin::Stats-->
                                <div
                                    class="border border-gray-300 border-dashed rounded min-w-80px py-3 px-4 mx-2 mb-3 @if ($supplier->id == 1) d-none @endif ">
                                    @can('delete-supplier')
                                        <button type="submit"
                                            onclick ="return confirm('Do you want to delete this supplier?')"
        ...
        @empty
            <div class="alert alert-danger d-flex align-items-center p-5 mb-10">
                ...
                <div class="d-flex flex-column">
                    ...
                    <span>Supplier no record found !.</span>
                </div>
            </div>
        @endforelse
    </div>
