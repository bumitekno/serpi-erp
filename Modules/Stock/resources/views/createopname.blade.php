...
@section('content')
    ...
    <div class="card">
        <div class="card-header mt-3">
            <div class="float-start">
                <h3>
                    <span class="text-dark"> History Stock Opname </span>
                </h3>
            </div>
            <div class="float-end ">
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <input type="text" id="kt_filter_search" data-kt-table-filter="search"
                        class="form-control form-control-solid form-select-sm w-150px ps-9 me-2" placeholder="Search">
                    <a href="{{ route('stock.download_stockopname') }}" class="btn btn-info btn-sm btn-export">Export</a>
                </div>
            </div>
        </div>
        <div class="card-body">
